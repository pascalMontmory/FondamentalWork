...
The current artifact is computational evidence, not a mathematical proof of generator quality. Missing material includes raw SmallCrush logs, stream adapter source or hash, backend implementation hashes, bit-exact stream hashes, x86 CPU raw logs, throughput benchmarks, and complete per-seed variance tables.
\end{abstract}
